...
<div>
  <div style="float: left" hspace="20">
    <a target="_blank" href="/figures/BL.png">
      <img src="/figures/BL.png" alt="Boundary Layer in Asymptotic Homogenization" width="150" height="100" style="vertical-align:middle"/>
    </a>
  </div>
...
<div>
  <div style="float: left" hspace="20">
    <a target="_blank" href="/figures/Shell.png">
      <img src="/figures/Shell.png" alt="Representation of Multi-Layered Thin Shell" width="180" height="100" style="vertical-align:middle"/>
    </a>
  </div>
  <div style="font-size: 16px">
