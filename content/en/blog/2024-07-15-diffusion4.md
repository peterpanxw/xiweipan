...
`\begin{align}
\nabla_{\pmb{x}}log\,q(\pmb{x}|\pmb{x}^\prime) &= \nabla_{\pmb{x}}log\frac{1}{\left(\sqrt{2\pi}\sigma\right)^d}\exp\left\lbrace-\frac{\|\pmb{x}-\pmb{x}^\prime\|^2}{2\sigma^2}\right\rbrace\\
&= \nabla_{\pmb{x}}\left\lbrace-\frac{\|\pmb{x}-\pmb{x}^\prime\|^2}{2\sigma^2}-log\left(\sqrt{2\pi}\sigma\right)^d\right\rbrace\\
